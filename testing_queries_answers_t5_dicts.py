...
queries_answers_df = pd.read_csv(os.path.join("data", "classified_queries_with_answers_41week.csv"), sep="\t")
...
for num, d in enumerate(queries_answers_dicts):
    text = d["Query"] + " Document: " + d["FastAnswerText"] + " Relevant: "
...
test_results_df.to_csv(os.path.join("data", "validate_queries_41week.csv"), sep="\t", index=False)